...
session_start();
  ...
  if(isset($_POST['add'])){
    ...
    $code = $_SESSION['code'];
      $ins_query="INSERT INTO feedback1 VALUES ('$code','6','6','$avg')";
      mysqli_query($con,$ins_query)
      or die(mysql_error());
     header("Location:submitcs.php");
  }
  ?>
...
<h2  id="g"></h2>
    <form method="POST" id="MYFORM"name="myform">
        <h3>(د.شیما عەلەوبی)(Compiler Construction) ھەڵسەنگاندن بو </h3>
      ...
      <br> 
       ...
       <a href="submitcs.html"><input type="submit" onclick="check()" id="add" name="add" value="Submit"></a>
            <br>
            <br>
</div>
